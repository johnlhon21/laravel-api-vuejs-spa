<template>
    <div class="content m-auto">
        <div class="col-10 m-auto">
            <div class="mt-2"><h2>Update User</h2></div>
            <div class="card mt-2">
    ...
    export default {
        ...
        methods: {
            updateUser(userId) {
                ...
                Vue.axios.put('/api/user/' + userId, this.user, {headers:this.$store.getters.getHeaders}).then((response) => {
                    ...
                    this.message = "Cannot update user.";
                    this.alertClass = "alert-danger";
                    console.log(error.response);
                });
            },
            getUser(userId) {
                Vue.axios.get('/api/user/' + userId, {headers:this.$store.getters.getHeaders}).then((response) => {
                    ...
                    this.message = "Cannot retrieve user.";
                    this.alertClass = "alert-danger";
                    console.log(error.response);
                });
            },
